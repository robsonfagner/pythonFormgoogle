...
# Repetindo o botão "Menos de 20 anos" 15 vezes
for _ in range(15):
    click_button('//*[@id="mG61Hd"]/div[2]/div/div[2]/div[1]/div/div/div[2]/div[1]/div[2]/label/div/div[2]/div/span')  # Menos de 20 anos

# Preenchendo as outras partes do formulário (somente uma vez)
