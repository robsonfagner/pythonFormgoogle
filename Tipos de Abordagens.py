...
def preencher_formulario(resposta):
    ...
    if resposta == ' Grupos de estudo online': click_button('//*[@id="mG61Hd"]/div[2]/div/div[2]/div[12]/div/div/div[2]/div[1]/div[1]/label/div/div[2]/div/span')  #  Grupos de estudo online
    elif resposta == 'Fóruns para discussões não acadêmicas': click_button('//*[@id="mG61Hd"]/div[2]/div/div[2]/div[12]/div/div/div[2]/div[1]/div[2]/label/div/div[2]/div/span')  # Fóruns para discussões não acadêmicas
    elif resposta == 'Projetos em equipe virtuais': click_button('//*[@id="mG61Hd"]/div[2]/div/div[2]/div[12]/div/div/div[2]/div[1]/div[3]/label/div/div[2]/div/span')  # Projetos em equipe virtuais
...
for _ in range(50):  #  Grupos de estudo online (50 vezes)
    preencher_formulario(' Grupos de estudo online')
for _ in range(20):  # Fóruns para discussões não acadêmicas (20 vezes)
    preencher_formulario('Fóruns para discussões não acadêmicas')
for _ in range(27):  # Projetos em equipe virtuais (27 vezes)
    preencher_formulario('Projetos em equipe virtuais')
